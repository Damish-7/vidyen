    ...
    return Obx(() {
      ...
      return Column(children: [
        ...
        Container(
          ...
          child: Row(children: [
            const Icon(Icons.workspace_premium_outlined, color: Color(0xFFBB86FC), size: 18),
            ...
            Container(
              ...
              child: Text('${controller.downloadedCount}/${controller.totalCount} Downloaded',
                  style: TextStyle(fontFamily: 'Sora', fontSize: r.sp(11),
                      color: const Color(0xFFBB86FC), fontWeight: FontWeight.w600)),
            ),
          ]),
        ),
        ...
        if (certs.isEmpty)
          Expanded(
            child: Center(
              child: Column(mainAxisSize: MainAxisSize.min, children: [
                ...
                Text('Certificates will appear after\nthe conference concludes.',
          ...
          Expanded(
            child: ListView.separated(
              ...
              itemBuilder: (_, i) => _CertCard(cert: certs[i], controller: controller, r: r),
            ),
          ),
      ]);
    });
...
class _CertCard extends StatelessWidget {
  final CertificateHiveModel cert;
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        Padding(
          ...
          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              ...
              if (cert.isDownloaded)
                Container(
                  ...
                  child: Row(mainAxisSize: MainAxisSize.min, children: [
                    ...
                    Text('Saved', style: TextStyle(fontFamily: 'Sora',
            ...
            // Download button
            GestureDetector(
              onTap: cert.isDownloaded ? null : () => controller.markDownloaded(cert),
              child: Container(
                ...
                decoration: BoxDecoration(
                  gradient: cert.isDownloaded
                      ? null
                      : LinearGradient(colors: [_typeColor, _typeColor.withOpacity(0.7)]),
                  color: cert.isDownloaded ? AppColors.textMuted.withOpacity(0.1) : null,
                  borderRadius: BorderRadius.circular(12),
                ),
                child: Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                  Icon(cert.isDownloaded ? Icons.check_rounded : Icons.download_rounded,
                      color: cert.isDownloaded ? AppColors.textMuted : AppColors.background,
                      size: 18),
                  const SizedBox(width: 8),
                  Text(cert.isDownloaded ? 'Already Downloaded' : 'Download Certificate',
                      style: TextStyle(fontFamily: 'Sora', fontSize: r.sp(13),
