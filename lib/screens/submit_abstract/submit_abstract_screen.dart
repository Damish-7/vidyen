            ...
            child: Column(children: [
              ...
              Container(
                ...
                child: Column(crossAxisAlignment: CrossAxisAlignment.start,
                  ...
                  _SectionLabel(label: 'Abstract Details',
                  ...
                  _SectionLabel(label: 'Abstract Text',
                      color: AppColors.highlight, r: r),
                  const SizedBox(height: 8),
                  Obx(() {
                    final len = controller.abstractTextController.text.length;
                    return Text('$len characters (min. 100)',
                        style: TextStyle(fontFamily: 'Sora',
                            fontSize: r.sp(11),
                            color: len < 100
                                ? AppColors.error
...
class _TypeButton extends StatelessWidget {
  ...
  final Responsive r;
  const _TypeButton({required this.label, required this.selected,
