          ...
          child: Column(children: [
            ...
            Padding(
              ...
              child: Row(children: [
                ...
                Text('Create Account',
                    style: TextStyle(fontFamily: 'Sora', fontSize: r.sp(20),
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        VidyenTextField(controller: controller.nameController,
            label: 'Full Name *', hint: 'Dr. Jane Smith',
            prefixIcon: Icons.badge_outlined,
            onChanged: (_) => controller.clearError()),
        const SizedBox(height: 14),
        VidyenTextField(controller: controller.emailController,
            label: 'Email Address *', hint: 'jane@university.edu',
            prefixIcon: Icons.email_outlined,
            keyboardType: TextInputType.emailAddress,
            onChanged: (_) => controller.clearError()),
        const SizedBox(height: 14),
        VidyenTextField(controller: controller.usernameController,
            label: 'Username *', hint: 'janesmith',
        ...
        const SizedBox(height: 16),
        VidyenTextField(controller: controller.designationController,
            label: 'Designation', hint: 'Assistant Professor',
            prefixIcon: Icons.work_outline_rounded,
            onChanged: (_) => controller.clearError()),
        const SizedBox(height: 14),
        VidyenTextField(controller: controller.institutionController,
            label: 'Institution / Organisation', hint: 'University of ...',
        ...
        const SizedBox(height: 16),
        Obx(() => VidyenTextField(controller: controller.regPasswordController,
            ...
            onChanged: (_) => controller.clearError())),
        const SizedBox(height: 14),
        Obx(() => VidyenTextField(controller: controller.confirmPasswordController,
...
class _SectionLabel extends StatelessWidget {
  ...
  final Color color;
  final Responsive r;
  const _SectionLabel({required this.label, required this.color, required this.r});
